  ...
  return (
    <div>
      ...
      <div className="grid min-h-screen grid-cols-4 gap-3 px-20 py-50">
        <CatContentButton
          className="col-span-1 col-start-2 border-[3px] border-[#333d79] rounded-2xl m-2 p-0 text-[#333d79] font-semibold text-center text-2xl"
          width={350}
          height={200}
          id={1}
          key={1}
        />
        <CatContentButton
          className="col-span-1 col-start-3 border-[3px] border-[#333d79] rounded-2xl m-2 p-0 text-[#333d79] font-semibold text-center text-2xl"
          width={350}
          height={200}
          id={2}
          key={2}
